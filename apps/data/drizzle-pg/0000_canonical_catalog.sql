...
--> statement-breakpoint
CREATE TABLE "retired_song_ids" (
	"id" bigint PRIMARY KEY NOT NULL,
	"parentId" bigint NOT NULL,
	"region" "region" NOT NULL,
	"gameVersion" smallint NOT NULL,
	CONSTRAINT "retired_song_ids_instance_unique" UNIQUE("parentId","region","gameVersion")
);
--> statement-breakpoint
CREATE TABLE "songs" (
...
--> statement-breakpoint
ALTER TABLE "retired_song_ids" ADD CONSTRAINT "retired_song_ids_parentId_parent_song_id_fk" FOREIGN KEY ("parentId") REFERENCES "public"."parent_song"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
