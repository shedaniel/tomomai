...
// discoverLinks calls an OpenRouter model to decide whether a page should be
// scraped — skip when no API key is configured (mirrors the TOKEN gate on the
// level-fetcher integration test).
describe.skipIf(!process.env.OPENROUTER_KEY)("discoverLinks integration", () => {
