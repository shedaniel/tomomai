...
// Core R2 plumbing (client, covers, catalog artifacts) lives in
// @tomomai/server/r2, shared with the data service. This module keeps the
// main-app-specific objects: user albums, icons, avatars.
