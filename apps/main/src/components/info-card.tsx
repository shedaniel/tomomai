...
import type { ProfilePrivacySettings, ProfileSettings, Region, SnapshotWithSongs } from "@/lib/types";
...
type InfoCardOwnerSettings = ReturnType<typeof useInfoCardOwnerSettings>;
...
function DescriptionDiscardDialog({ controller }: { controller: DescriptionController }) {
  const t = useTranslations();
...
function ConfirmUnpublishDialog({ controller }: { controller: VisibilityController }) {
  const t = useTranslations();
